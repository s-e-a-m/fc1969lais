declare name "ALVIN LUCIER - I'M SITTING IN A ROOM (1969) - AMBISONIC VERSION";
declare version "001";
...
process = ctrlgroup(wxyzrip) : main, main, main, main : ctrlgroup(hgroup("[03] ", *(g88), *(g88), *(g88), *(g88) : svmeter, svmeter, svmeter, svmeter));
