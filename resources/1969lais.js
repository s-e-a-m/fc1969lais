...
function getJSON1969lais() {
	return '{"name": "1969lais","filename": "1969lais.dsp","version": "2.28.8","compile_options": "-lang wasm -scal -ftz 2","library_list": ["/usr/local/share/faust/stdfaust.lib","/usr/local/share/faust/maths.lib","/usr/local/share/faust/platform.lib","/usr/local/share/faust/delays.lib","/usr/local/share/faust/basics.lib","/usr/local/share/faust/signals.lib","/usr/local/share/faust/analyzers.lib"],"include_pathnames": ["/usr/local/share/faust","/usr/local/share/faust","/usr/share/faust",".","/tmp/sessions/A00CF65568247B135C1A13105702E687AD4EC3D3/web/wasmjs"],"size": 268435528,"inputs": 1,"outputs": 1,"meta": [ { "analyzers.lib/name": "Faust Analyzer Library" },{ "analyzers.lib/version": "0.1" },{ "author": "Giuseppe Silvi" },{ "basics.lib/name": "Faust Basic Element Library" },{ "basics.lib/version": "0.1" },{ "copyright": "(c)SEAM 2019" },{ "delays.lib/name": "Faust Delay Library" },{ "delays.lib/version": "0.1" },{ "description": "Alvin Lucier, I am sitting in a room - live electronic model" },{ "filename": "1969lais.dsp" },{ "license": "GNU-GPL-v3" },{ "maths.lib/author": "GRAME" },{ "maths.lib/copyright": "GRAME" },{ "maths.lib/license": "LGPL with exception" },{ "maths.lib/name": "Faust Math Library" },{ "maths.lib/version": "2.3" },{ "name": "1969lais" },{ "options": "[midi:on] [httpd:on]" },{ "platform.lib/name": "Generic Platform Library" },{ "platform.lib/version": "0.1" },{ "signals.lib/name": "Faust Signal Routing Library" },{ "signals.lib/version": "0.0" },{ "version": "010" }],"ui": [ {"type": "vgroup","label": "1969lais","items": [ {"type": "vgroup","label": "Check both boxes to start","meta": [{ "01": "" }],"items": [ {"type": "checkbox","label": "Uncheck me after the incipit","address": "/1969lais/Check_both_boxes_to_start/Uncheck_me_after_the_incipit","index": 268435488,"meta": [{ "01": "" }]},{"type": "checkbox","label": "I am Sitting... Uncheck me at the end","address": "/1969lais/Check_both_boxes_to_start/I_am_Sitting..._Uncheck_me_at_the_end","index": 12,"meta": [{ "02": "" }]}]},{"type": "hgroup","label": "0x00","meta": [{ "02": "" }],"items": [ {"type": "hgroup","label": "0x00","meta": [{ "03": "" }],"items": [ {"type": "vslider","label": "0x00","address": "/1969lais/0x00/0x00/0x00","index": 0,"meta": [{ "08": "" },{ "midi": "ctrl 88" }],"init": 0,"min": -70,"max": 6,"step": 0.1},{"type": "vbargraph","label": "0x2dd0e40","address": "/1969lais/0x00/0x00/0x2dd0e40","index": 268435524,"meta": [{ "90": "" },{ "unit": "dB" }],"min": -70,"max": 6}]}]}]}]}';
}
/*
 faust2webaudio
